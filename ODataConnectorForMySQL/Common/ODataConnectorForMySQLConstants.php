<?php
/** 
 * Class which holds definition of OData MySQL Connector constants
 * 
 * PHP version 5.3
 * 
...
/**
 * Class for OData MySQL Connector constants
 * 
 * @category  ODataConnectorForMySQL
 * @package   ODataConnectorForMySQL_Common
 * @author    Yash K. Kothari <odataphpproducer_alias@microsoft.com>
 ...
 * @link      
 */
class ODataConnectorForMySQLConstants
{
    //Element configuration for Service.config
    const CONFIGURATION = 'configuration';

    //Element services for Service.config
    const SERVICES = 'services';

    //Element baseURL for Service.config
    const BASEURL = 'baseURL';

    //Element classname for Service.config
    const CLASSNAME = 'classname';

    //Element path for Service.config
    const PATH = 'path';
    
    //Element Mapping Details
    const MAPPING_DETAILS = 'MappingDetails';

    //Element ConnectionParams
    ...
    //Element MapEntity
    const MAP_ENTITY = 'MapEntity';

    //Attribute UserEntityName
    const USER_ENTITY_NAME = 'UserEntityName';

    //Attribute DBEntityName
    const DB_ENTITY_NAME = 'DBEntityName';    

    //Element MapProperty
    const MAP_PROPERTY = 'MapProperty';

    //Attribute UserPropertyName
    const USER_PROPERTY_NAME = 'UserPropertyName';

    //Attribute DBPropertyName
    const DB_PROPERTY_NAME = 'DBPropertyName';    
    ...
    const ENTITY_NAME_INFO = 'EntityNameInformation';

    // Entity name information 
    const ENTITY_NAME = 'EntityName';
    
    // db name of entity type. 
    const DB_NAME = 'dbName';
    
    // entity type name of entity type. 
    const ENTITY_TYPE_NAME = 'EntityTypeName';
    
    // entity type name of entity type. 
    const ENTITY_SET_NAME = 'EntitySetName';
    ...
    //Length attribute Name in csdl.
    const LENGTH = 'Length';
    
    //Fixed attribute Name in csdl.
    const FIXED = 'Fixed';
    
    //Unsigned attribute Name in csdl.
    const UNSIGNED = 'Unsigned';
    
    //Default attribute Name in csdl.
    const DEFAULT1 = 'DefaultValue';
    
    //AutoIncrement attribute Name in csdl.
