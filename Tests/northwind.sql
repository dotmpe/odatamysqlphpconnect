...
--
-- Host: localhost
-- Generation Time: Nov 11, 2011 at 06:21 PM
...
CREATE TABLE IF NOT EXISTS `order_details` (
  ...
  KEY `FK_order_details_productid` (`ProductID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2156 ;
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `Discontinued` binary(1) NOT NULL,
